...
trait LogsAdminActivity
{
     ...
     * @param $user The user being acted upon
     * @param array $details Additional details for the log
     */
     ...
     *
     * @param string $action The action being logged
     * @param $subscription The subscription being acted upon
     * @param array $details Additional details for the log
     */
     ...
     *
     * @param string $action The action being logged
     * @param $contact The contact being acted upon
     * @param array $details Additional details for the log
     */
     ...
     *
     * @param string $action The action being logged
     * @param $role The role being acted upon
     * @param array $details Additional details for the log
     */
    public function logRoleActivity(string $action, $role = null, array $details = []): void
    {
        $description = match($action) {
            ...
            'role_deleted' => "Admin deleted role: '" . ($details['role_name'] ?? ($role ? $role->name : 'unknown')) . "'",
