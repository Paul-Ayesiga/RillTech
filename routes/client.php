...
// Subscription success route (accessible without auth - for Stripe returns)
...
// Protected routes
Route::middleware(['auth', 'verified', 'user.status', 'stripe.return', 'role_or_permission:client|super-admin'])->group(function () {
